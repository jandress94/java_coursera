...
public final class CoarseLists {
    ...
    private static final class PhonyLock {
        public void lock() {}
        public void unlock() {}

        public PhonyLock readLock() { return new PhonyLock(); }
        public PhonyLock writeLock() { return new PhonyLock(); }
    }
    /**
